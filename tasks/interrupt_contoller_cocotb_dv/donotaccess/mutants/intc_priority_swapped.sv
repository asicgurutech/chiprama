...
// ============================================================
    ...
    always @(*) begin
        casez (ipr)
            8'b????_???1 : begin priority_vect = 3'd1; priority_valid = 1'b1; end  // MUTANT: IRQ0/IRQ1 priority swapped
            8'b????_??10 : begin priority_vect = 3'd0; priority_valid = 1'b1; end  // MUTANT
