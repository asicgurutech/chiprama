"""Tasks for the chiprama interrupt-controller chip-design environment.

Run locally:  hud eval tasks.py claude --task-ids interrupt-controller-cocotb-dv --group 1 -y
